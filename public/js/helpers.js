...
export function calculateNeckRotationAngle(leftShoulder, nose, rightShoulder) {
    const vector1 = [nose.x - leftShoulder.x, nose.y - leftShoulder.y];
    const vector2 = [rightShoulder.x - leftShoulder.x, rightShoulder.y - leftShoulder.y];
