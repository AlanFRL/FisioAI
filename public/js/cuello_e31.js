import { calculatePrecision, showVisualMessage, calculateNeckInclination } from './helpers.js';
...
holistic.onResults(results => {
    ...
    if (poseLandmarks) {
        ...
        const angle = calculateNeckInclination(leftShoulder, nose, rightShoulder);
        ...
        if (exerciseStarted) {
            // Detectar flexión
            if (angle > 85 && angle < 95 && !isFlexing) {
                isFlexing = true;
            }
            if ((angle > 100 || angle < 75) && isFlexing) {
